<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="tabel_msk" class="display">
                <thead>
                    <tr>
                        <th>Tanggal</th>
                        <th>Nama Barang</th>
                    ...
                    <?php foreach ($data as $d) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url("barang/hapusmasuk/${d['id']}") ?>" onclick="return confirm('Yakin untuk menghapus?')" class="badge bg-danger text-decoration-none">
...
<div class="modal fade" id="input" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url("barang/addmasuk") ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Form Barang Masuk</h5>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url("barang/updatemasuk") ?>" method="post">
